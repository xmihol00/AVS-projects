...
defs=(
    "-DSEPARATE_MEMORY -DVECTORIZED_SIMD -DPRINT_DEFINES -DSCHEDULE=guided" 
    "-DSEPARATE_MEMORY -DVECTORIZED_SIMD -DPRINT_DEFINES -DSCHEDULE=guided -DCHUNK_SIZE=8"
    "-DSEPARATE_MEMORY -DVECTORIZED_SIMD -DPRINT_DEFINES -DSCHEDULE=guided -DCHUNK_SIZE=16" 
    #"-DSEPARATE_MEMORY -DVECTORIZED_SIMD -DPRINT_DEFINES -DSCHEDULE=guided -DCHUNK_SIZE=32"
    #"-DSEPARATE_MEMORY -DVECTORIZED_SIMD -DPRINT_DEFINES -DSCHEDULE=guided -DCHUNK_SIZE=64"
)
files=(
    "guided_default"
    "guided_8"
