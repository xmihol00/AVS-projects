...
defs=(
    "-DPRINT_DEFINES -DSCHEDULE=guided" 
    "-DPRINT_DEFINES -DSCHEDULE=guided -DCHUNK_SIZE=8"
    "-DPRINT_DEFINES -DSCHEDULE=guided -DCHUNK_SIZE=16" 
    "-DPRINT_DEFINES -DSCHEDULE=guided -DCHUNK_SIZE=32"
    "-DPRINT_DEFINES -DSCHEDULE=guided -DCHUNK_SIZE=64"
)
files=(
    "guided_default"
    "guided_8"
